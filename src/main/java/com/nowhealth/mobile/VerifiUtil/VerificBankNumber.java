...
public class VerificBankNumber {
	
	 public String testNumber(String bankNuber) {  
	        //String cardNumber = "6210676802084484923";//卡号  
		    //String cardNumber = "6228480128240307370";//卡号  
	        String name = getNameOfBank(bankNuber);  
	    ...
	    public static String getNameOfBank(String idCard) {  
	        ...
	        if (index != -1) {  
	        	System.out.print("银行名称为======="+bankName[index]);
